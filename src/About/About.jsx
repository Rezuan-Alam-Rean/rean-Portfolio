        ...
        <div className="flex-[0.75] bg-black-100 p-8 rounded-2xl md:w-1/2 my-5">
          <div className="p-3 leading-6 ">
            <p className="text-white font-poppins ">
              <span className="text-xl font-bold text-white"> Hey there! </span>{" "}
              <br />
              I'm Rezuan Alam Rean ......
              I'm a passionate MERN stack developer with a solid foundation in
              React, JavaScript, Node.js, MongoDB, HTML, and CSS. <br />
              I'm also a Computer Science and Engineering student with a passion
              for coding and innovation. <br /> I'm currently expanding my
              knowledge by learning Next.js to become a well-rounded full-stack
              developer. <br /> I'm excited about learning new technologies and
              contributing to open-source projects. <br />Thank you .
            </p>
            <a href="#contact">
              <button className="btn bg-purple-100 mt-4 md:mt-6">
                Contact Me{" "}
              </button>
            </a>
          </div>
